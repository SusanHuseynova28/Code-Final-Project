...
export default function AboutUs() {
  return (
    <>
      ...
      >
        <div className="py-10">
          <h2 className="text-[45px] font-semibold text-white mt-24">
            About Us #1
          </h2>
      ...
      <div className="container flex flex-col justify-center items-center py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="flex ">
              ...
              <p className="text-xs uppercase tracking-widest mt-2 text-[#969696] pl-4 ">
                The High Stress Favourite
              </p>
            </div>
            <p className="text-hovercolor3 w-[550px] mt-4">
            ...
            <p className="mt-4 text-hovercolor3 w-[550px]">
          ...
          <div className="flex justify-center">
            <img
              ...
              alt="Our Story"
              className="w-[550px] h-[500px] object-cover transform transition-transform duration-300 hover:scale-95"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex ">
              <p className="border-t border-customBackground w-[40px] my-4 border-2"></p>
              <p className="text-sm uppercase tracking-widest  text-[#969696] mt-2 pl-4">
