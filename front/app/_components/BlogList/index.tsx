  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start">
        <aside className="max-w-[400px] mt-10 px-4 lg:pl-16 w-full lg:w-auto">
          <div className="relative mt-6">
            <input
              type="text"
              placeholder="Search..."
              className="w-full px-4 py-2 border border-gray-300 outline-none hover:outline-none"
            />
          ...
          <h3 className="text-[17px] mt-10 text-center lg:text-left">
            C a t e g o r i e s
          </h3>
          <div className="border border-dotted mb-4"></div>
          <ul className="space-y-2 border-b border-gray-300 pb-4 text-center lg:text-left">
          ...
          <h3 className="text-[17px] mt-10 mb-4 text-center lg:text-left">
            R e c e n t P o s t s
          </h3>
          <div className="border mb-4"></div>
          <ul className="space-y-6 mt-10">
            <li className="flex flex-col items-center lg:flex-row lg:items-start lg:space-x-4">
              <img
          ...
          <div className="w-full lg:w-1/4 space-y-8 mt-10 text-center lg:text-left">
            <div>
              <h3 className="text-md">T A G S</h3>
              <div className="border mt-4"></div>
              <div className="flex flex-wrap justify-center lg:justify-start gap-2 text-[#969696] mt-10 w-full lg:w-[250px]">
        ...
        <div className="flex justify-center lg:justify-start">
          <main className="container p-4 lg:p-10 mt-6 w-full text-center lg:text-left">
            {currentArticles.map((article) => (
              <div
                key={article.id}
                className="flex flex-col items-center lg:items-start lg:flex-row mb-8 border-b pb-4"
              >
                ...
                <div className="w-full lg:w-2/3 lg:pl-44 mt-4 lg:mt-0 px-4 lg:px-10">
                  <p className="text-xs text-customBackground">NEWS</p>
                  <h2 className="text-2xl font-semibold mt-4 hover:text-customBackground">
                    {article.title}
                  </h2>
